@extends('layouts.app', ['title' => 'Data Anggota'])
@section('content')
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ url('anggota') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="txtjenis_kelamin" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="txttgl_lahir" placeholder="Tanggal lahir" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" rows="2" oninput="setCustomValidity('')" />
                        </div>
                    </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $data ->alamat }}</td>
                    <td><a href="{{ route('anggota.edit', $data->id) }}" class="btn btn-warning"><i class="fa fa-edit"></i></a></td>
                    <td>
                        <form action="{{ route('anggota.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')" >
                            @csrf
                            @method('DELETE')
